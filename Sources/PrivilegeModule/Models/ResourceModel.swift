...
package final class ResourceModel<T: Resource>: PGModel, @unchecked Sendable  {
    ...
    package struct Fields: PGFields {
        ...
        let type = PGField("type",
            .enum(T.ResourceType.self, as: "resource_type")
        )                                                       .required
    ...
    @Field(fields.type)                         var type: T.ResourceType
    ...
    package typealias MIG = DefaultMIG<ResourceModel>
}
