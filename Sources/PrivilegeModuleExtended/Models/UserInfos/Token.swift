...
public extension __SDBM{
    final class Token: PGModel, @unchecked Sendable {
        ...
        @Parent(fields.userId)                                          package var user: User
        @Field(fields.credential)                                       package var credential: String
        @Field(fields.token)                                            package var token: String
        @Field(fields.valid)                                            package var valid: Bool
        @Field(fields.expireAfter)                                      package var expireAfter: Int
